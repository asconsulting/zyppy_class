...
$GLOBALS['TL_DCA']['tl_page']['fields']['exclusiveClass'] = [
    'inputType' => 'select',
    'eval' => ['tl_class' => 'w50'],
	'sql' => ['type' => 'string', 'length' => 64, 'default' => ''],
];

$GLOBALS['TL_DCA']['tl_page']['fields']['commonClasses'] = [
    'inputType' => 'checkboxWizard',
    'eval' => ['multiple' => true, 'tl_class' => 'w50 wizard50'],
    'sql' => ['type' => 'blob', 'notnull' => false],
];

$GLOBALS['TL_DCA']['tl_page']['fields']['globalCommonClasses'] = [
    'inputType' => 'checkboxWizard',
    'eval' => ['multiple' => true, 'tl_class' => 'w50 wizard50'],
    'sql' => ['type' => 'blob', 'notnull' => false],
];
...
foreach ($GLOBALS['TL_DCA']['tl_page']['palettes'] as $key => $value) {
	if (!is_array($value)) {
		$objPalette->applyToPalette($key, 'tl_page');
	}
}
