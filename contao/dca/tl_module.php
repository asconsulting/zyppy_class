...
$GLOBALS['TL_DCA']['tl_module']['fields']['exclusiveClass'] = [
    'inputType' => 'select',
    'eval' => ['tl_class' => 'w50'],
	'sql' => ['type' => 'string', 'length' => 64, 'default' => ''],
];

$GLOBALS['TL_DCA']['tl_module']['fields']['commonClasses'] = [
    'inputType' => 'checkboxWizard',
    'eval' => ['multiple' => true, 'tl_class' => 'w50 wizard50'],
    'sql' => ['type' => 'blob', 'notnull' => false],
];

$GLOBALS['TL_DCA']['tl_module']['fields']['globalCommonClasses'] = [
    'inputType' => 'checkboxWizard',
    'eval' => ['multiple' => true, 'tl_class' => 'w50 wizard50'],
    'sql' => ['type' => 'blob', 'notnull' => false],
];
...
foreach ($GLOBALS['TL_DCA']['tl_module']['palettes'] as $key => $value) {
	$objPalette->applyToPalette($key, 'tl_module');
}
