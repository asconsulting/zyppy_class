...
$GLOBALS['TL_DCA']['tl_page']['config']['onload_callback'][] = array('ZyppyClass\Backend\ZyppyClass', 'setupRequiredFields');
$GLOBALS['TL_DCA']['tl_page']['config']['onload_callback'][] = array('ZyppyClass\Backend\ZyppyClass', 'hideUnconfigured');

foreach ($GLOBALS['TL_DCA']['tl_page']['palettes'] as $key => $value) {
	$GLOBALS['TL_DCA']['tl_page']['palettes'][$key] = str_replace(';{expert_legend', ';{class_legend},commonClasses,globalCommonClasses,exclusiveClass;{expert_legend', $value);
}
