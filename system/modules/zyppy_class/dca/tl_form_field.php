...
$GLOBALS['TL_DCA']['tl_form_field']['config']['onload_callback'][] = array('ZyppyClass\Backend\ZyppyClass', 'setupRequiredFields');
$GLOBALS['TL_DCA']['tl_form_field']['config']['onload_callback'][] = array('ZyppyClass\Backend\ZyppyClass', 'hideUnconfigured');
