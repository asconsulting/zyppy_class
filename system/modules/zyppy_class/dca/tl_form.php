...
$GLOBALS['TL_DCA']['tl_form']['config']['onload_callback'][] = array('ZyppyClass\Backend\ZyppyClass', 'setupRequiredFields');
$GLOBALS['TL_DCA']['tl_form']['config']['onload_callback'][] = array('ZyppyClass\Backend\ZyppyClass', 'hideUnconfigured');
